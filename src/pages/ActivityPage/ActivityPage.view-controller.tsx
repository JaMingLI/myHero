          ...
          <div className="flex-1 lg:max-w-[50%]">
            ...
            {isLoadingRepos ? (
              ...
              <div className="bg-[var(--card)] rounded-lg p-4 md:p-5 text-center">
                <p className="text-[var(--color-text-secondary)] text-sm">{t("activity.noRepos")}</p>
              </div>
            ) : (
              <motion.div
